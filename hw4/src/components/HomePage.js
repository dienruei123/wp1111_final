  ...
  return (
    <div className="HomeWrapper">
      ...
      <div className="controlContainer">
        <button className="btn" onClick={showPanelOnClick}>
        ...
        {showPanel ? (
          <div className="controlWrapper">
            {error ? (
              <div
                className="error"
                style={error ? { color: "#880000" } : { color: "#0f0f4b" }}
              >
            ...
            <div className="controlPanel">
              <div className="controlCol">
                ...
                <input
                  ...
                  onChange={(event) => mineNumOnChange(event.target.value)}
                />
                <p
              ...
              <div className="controlCol">
                ...
                <input
                  ...
                  onChange={(event) => boardSizeOnChange(event.target.value)}
                />
                <p
                  className="controlNum"
                  style={error ? { color: "#880000" } : { color: "#0f0f4b" }}
